...
##################################################################
# sjpeg converter script with contrast + color enhancement (v1.2)
# Dependencies: PIL (Pillow), Python 3
##################################################################
...
for i in range(spilts):
    ...
    # Apply contrast and color enhancement
    ...
    crop.save(temp_path, quality=95, subsampling=0)
